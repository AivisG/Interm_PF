...
class GaussianProcessModel:
    def __init__(self, n_restarts_optimizer=10, alpha=1e-2, normalize_y=True):
        ...
        """
        self.kernel = C(1.0) * Matern(length_scale=5, length_scale_bounds=(1e-2, 1e5)) + WhiteKernel(noise_level=1e-5, noise_level_bounds=(1e-8, 1e-1))
    ...
    def validate(self, X, y):
        ...
        ax.set_title("Fig 7 Gaussian Process: Training vs Validation RMSE")
        ax.set_ylabel("RMSE")
        ax.grid(axis="y")
